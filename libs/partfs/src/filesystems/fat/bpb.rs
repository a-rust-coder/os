...
pub struct BiosParameterBlockCommon {
    ...
    /// sector of the volume. This field is used to align the start of the data area to integral
    /// multiple of the cluster size with respect to the start of the partition/media.
    ///
...
pub struct ExtendedBpb12_16 {
    ...
    pub(crate) file_system_type: [u8; 8],

    /// Boot code. Usually 0 if data only volume.
    pub(crate) boot_code: [u8; 448],
...
pub struct ExtendedBpb32 {
    ...
    /// Bits 8 ~ 16: reserved.
    pub(crate) extra_flags: [u8; 2],

    /// Must be 0.
    pub(crate) filesystem_version: u16,
